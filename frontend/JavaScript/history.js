                ...
                if (data.history.length === 0) {
                    ...
                    data.history.forEach(item => {
                        ...
                        tr.innerHTML = `
                            ...
                            <td style="min-width: 280px; padding: 10px;">${window.generateLeaveInformationHTML(item.leave_reason, item.parent_confirmed, item.request_status, item.warden_remarks)}</td>
                        `;
                        tbody.appendChild(tr);
                    });
                }
